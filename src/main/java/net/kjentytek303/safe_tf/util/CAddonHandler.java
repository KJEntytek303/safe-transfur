...
import static net.kjentytek303.safe_tf.init.InitEffects.UNSAFE_SERUM;


/**
 * DO NOT CALL ANYTHING HERE WITHOUT ENSURING THAT ModList.get().isLoaded("changed_addon") IS TRUE!!!
 */
public class CAddonHandler {

	public static void onPlayerTickHandleCAddon(TickEvent.PlayerTickEvent event) {
	...
	public static void handleCAddonMinigame(ProcessTransfur.KeepConsciousEvent event) {
